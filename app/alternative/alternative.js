...
$scope.machineregistration = {id: null,ip:"",user_name:"",pass:"",master_location:"",slave_location:"",machine_id:""};
 ...
 $scope.newmachine = function(){  
       ...
       var machineregistration = {"ip":$scope.ip,"user_name":$scope.user_name,"pass":$scope.pass,"master_location":$scope.master_location,"slave_location":$scope.slave_location,"machine_id":$scope.MachineID};
