...
//alert(localStorage.getItem("access_token"));
  ...
  //  }
    $rootScope.$on("$locationChangeStart", function (event, next, current) {
     ...
     if (localStorage.getItem("tenant_id") == null && $rootScope.currentPath != '/registration'  && $rootScope.currentPath != '/machinenew' && $rootScope.currentPath != '/oee' && $rootScope.currentPath != '/shiftpart' && $rootScope.currentPath != '/cyclestop' && $rootScope.currentPath != '/hmi' && $rootScope.currentPath != '/dashboardnew' && $rootScope.currentPath != '/faq_question' && $rootScope.currentPath != '/alldetails' && $rootScope.currentPath != '/companydetails' && $rootScope.currentPath != '/frontpage' && $rootScope.currentPath != '/chart' && $rootScope.currentPath != '/lmw' && $rootScope.currentPath != '/adminuser' && $rootScope.currentPath != '/device' && $rootScope.currentPath != '/setting'  && $rootScope.currentPath != '/tenant' && $rootScope.currentPath != '/device_registration' && $rootScope.currentPath != '/changepassword' && $rootScope.currentPath != '/statuschart') {
        $location.path('/login')
        return;
      }
